...
public static class Moogle
{
    ...
    public static SearchResult Query(string pepe)
    {
        ...
        List<double> TempQuery = Herramientas.MultV(Query_Vec, Datos.vector_idf);
        List<double> FQuery = Herramientas.MultV(presencia, TempQuery);
        List<double> ScoreVec = Herramientas.MultM(Datos.TFIDF, FQuery);
        ...
        List<double> FScore = Herramientas.MultV(relevancia, ScoreVec);
        ...
        return new SearchResult(Ordenar.Sort(items), Levens.SugestionResult(QueryPalabras,PalabrasTotales));
    }
}
